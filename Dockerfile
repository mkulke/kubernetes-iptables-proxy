...
ADD https://4575d634297ff511433d-2bdefcf148e17ef637d032af30e6c26a.ssl.cf3.rackcdn.com/2.0.11/etcdctl /
RUN chmod +x /kubectl /etcdctl

CMD /etcdctl --peers ${ETCD_SERVERS} exec-watch --recursive /registry/services -- sh -c 'ruby /iptables-routing.rb'
